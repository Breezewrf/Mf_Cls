...
def get_train_args():
    ...
    parser.add_argument('--branch', type=int, default=6, help='denotes the number of streams')
    parser.add_argument('--seed', type=int, default=59363379)
    ...
    parser.add_argument('--deep', type=bool, default=False, help='use deep supervise or not')
    parser.add_argument('--use_cam', type=bool, default=False, help='use CAM supervise or not')
...
def get_test_args():
    ...
    parser.add_argument('--learning-rate', '-l', metavar='LR', type=float, default=1e-5,
                        help='Learning rate', dest='lr')
    parser.add_argument('--load', '-f', type=str,
                        default="/media/breeze/dev/Mf_Cls/checkpoints/unified/streams6-epochs[500]-bs[2]-lr[0.0003]-c2-ds[prostatex]-modal[pre_fuse]-focal-sigmoid/best_epoch.pth",
                        help='Load model from a .pth file')
    parser.add_argument('--scale', '-s', type=float, default=1, help='Downscaling factor of the images')
    parser.add_argument('--validation', '-v', dest='val', type=float, default=10.0,
                        help='Percent of the data that is used as validation (0-100)')
    ...
    parser.add_argument('--model', type=str, default='msf', help='choose model from: unet, unetpp, msfunet, mfcls')
    parser.add_argument('--branch', type=int, default=6, help='denotes the number of streams')
    parser.add_argument('--seed', type=int, default=57749867)
    parser.add_argument('--aug', type=int, default=1, help='set aug equal to 1 to implement augmentation')
    parser.add_argument('--opt', type=str, default='adamw')
    parser.add_argument('--task', type=str, default='seg')
    parser.add_argument('--desc', type=str)
    parser.add_argument('--deep', type=bool, default=False, help='use deep supervise or not')
    parser.add_argument('--use_cam', type=bool, default=True, help='use CAM supervise or not')
    return parser.parse_args()
