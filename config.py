...
def get_train_args():
    ...
    parser.add_argument('--deep', type=bool, default=True, help='use deep supervise or not')
...
def get_test_args():
    ...
    parser.add_argument('--learning-rate', '-l', metavar='LR', type=float, default=1e-5,
                        help='Learning rate', dest='lr')
    parser.add_argument('--load', '-f', type=str,
                        default="/media/breeze/dev/Mf_Cls/checkpoints/unified/epochs[500]-bs[4]-lr[0.0003]-c2-ds[prostatex]-modal[pre_fuse]-focal-deep/checkpoint_epoch300.pth",
                        help='Load model from a .pth file')
    parser.add_argument('--scale', '-s', type=float, default=1, help='Downscaling factor of the images')
    parser.add_argument('--validation', '-v', dest='val', type=float, default=10.0,
                        help='Percent of the data that is used as validation (0-100)')
