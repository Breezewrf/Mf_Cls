...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='/media/breeze/dev/Mf_Cls/checkpoints/checkpoint_epoch1.pth',
                        metavar='FILE',
                        help='Specify the file in which the model is stored')
    parser.add_argument('--input', '-i', metavar='INPUT', nargs='+', help='Filenames of input images',
                        default='/media/breeze/dev/Mf_Cls/data/T2W_images/Lesion_2_1.jpg')
